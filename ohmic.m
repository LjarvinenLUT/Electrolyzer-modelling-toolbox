...
function Uohm = ohmic(varargin)
    ...
    m = parser.Results.m;
    w = parser.Results.w;
    Workspace.Variables = struct('current',[],'voltage',[]);
    Workspace.Variables.T = parser.Results.Temperature;
    ...
    switch resistanceModel
        ...
        case 2
            ...
            if ~isnumeric(Workspace.Variables.T) || isempty(Workspace.Variables.T)
